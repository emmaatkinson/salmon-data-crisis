...
polygon(x=c(1930,1935,1935,1930), y=c(0,0,3000,3000), col=alpha("blue",.5), border=NA)
polygon(x=c(1950,1955,1955,1950), y=c(0,0,3000,3000), col=alpha("blue",.5), border=NA)
...
polygon(x=c(1995,1998,1998,1995), y=c(0,0,3000,3000), col=alpha("red",.5), border=NA)
polygon(x=c(1998,1999,1999,1998), y=c(0,0,3000,3000), col=alpha("red",.9), border=NA)
...
lines(d$Year, d$count, lwd=3)
points(d[d$Year%in%key.years,]$Year,d[d$Year%in%key.years,]$count, pch=20,cex=1.5, col="black")
